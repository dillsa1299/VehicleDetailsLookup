...
namespace VehicleDetailsLookup.Services.VehicleMapper
{
    ...
    public interface IVehicleMapperService
    {
        ...
        /// </returns>
        VehicleModel MapDetails(VehicleModel vehicle, VesResponse vesSearchResponse, MotSearchResponse motSearchResponse);
        ...
        /// </returns>
        VehicleModel MapAI(VehicleModel vehicle, AiSearchResponse aiResponse, AiType searchType);
    }
}
